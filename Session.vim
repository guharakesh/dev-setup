...
silent only
cd ~\dev\vagrant\dev-setup
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +5 shell\config-vim.sh
badd +1 shell\install-puppet.sh
argglobal
silent! argdel *
argadd shell\config-vim.sh
edit shell\config-vim.sh
...
5
normal! 0
lcd ~\dev\vagrant\dev-setup
wincmd w
argglobal
edit ~\dev\vagrant\dev-setup\shell\install-puppet.sh
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
